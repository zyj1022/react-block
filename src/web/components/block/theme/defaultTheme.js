...
export const fontSizeSm = th('fontSizeBase', fontSize => modularScale(-1, fontSize),)
export const fontSizeLg = th('fontSizeBase', fontSize => modularScale(1, fontSize),)
...
export const controlFocusBorderColor = th('primary', color => lighten(0.25, color),)

export const controlFocusBoxShadow = props => color => css `0 0 0 0.2rem ${th(color, c => transparentize(0.75, c))}`
...
export const transitionBase = safeTransitionProperties.map(prop => `${prop} .2s ease-in-out`).join(',')
...
export const modalContentBorderColor = th('black', color => transparentize(0.8, color),)
export const modalContentBorderRadius = th('borderRadiusLg')
export const modalContentBoxShadowXs = css `0 .25rem .5rem ${th('black', color => transparentize(0.8, color),)}`
export const modalContentBoxShadowSmUp = css `0 .5rem 1rem ${th('black', color => transparentize(0.8, color),)}`
...
export const alertVariant = props => baseColor => css `
    ...
    hr {
      border-top-color: ${props => darken(0.05, mixin('colorLevel', th(baseColor), th('alertColorLevel'))(props),)};
    }
  `
